...
{ 
  try{$sql ="UPDATE funcionario SET Status = 'Inativo' WHERE idFunc = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return TRUE;
...
{ 
  try{$sql ="UPDATE funcionario SET Status = 'Ativo' WHERE idFunc = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return TRUE;
...
{
  try{$sql =" UPDATE cliente SET Status = 'Inativo' WHERE idCliente = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return TRUE;
...
{
  try{$sql =" UPDATE cliente SET Status = 'Ativo' WHERE idCliente = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return TRUE;
...
{  try {
    $sql =
    "INSERT INTO fornecedor (Nome,Telefone,Contato,Status)
     VALUES(?,?,?,'Ativo')";
    $q = $this->prepare($sql);
    $q->bindParam(1,$obj->__getNome());
...
{ 
  try{$sql =" UPDATE fornecedor SET Status = 'Inativo' WHERE idFornecedor = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return true;
...
{ 
  try{$sql =" UPDATE fornecedor SET Status = 'Ativo' WHERE idFornecedor = ? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return true;
...
{ 
  try{$sql ="DELETE from cheque WHERE idCheque =? ";
       $q = $this->prepare($sql);
       $q->bindParam(1,$id);
       $q->execute(); 
       return true;
...
public function __insertCompra($oComp){
 ...
 // ***********************************DELETE DE COMPRA***********
  public function __deleteCompra($id){
     ...
     try{$sql = "DELETE from compra WHERE idCompra =? ";
...
return TRUE;
 ...
 public function __deleteVenda($id){
     ...
     try{$sql = "DELETE from venda WHERE idVenda =? ";
...
WHERE idVenda = ?;";
 ...
 // ***********************************DELETE DE DESPESA***********
  public function __deleteDespesa($id){
     ...
     try{$sql = "DELETE from despesas WHERE idDespesas =? ";
...
return TRUE;
 ...
 public function __InativarSacoPlastico($id){
     ...
     try{$sql = "UPDATE sacoplastico SET Status = 'Inativo' WHERE IdSaco = ? ";
 ...
 public function __AtivarSacoPlastico($id){
     ...
     try{$sql = "UPDATE sacoplastico SET Status = 'Ativo' WHERE IdSaco = ? ";
...
return TRUE;
 ...
 public function __deletePagamento($id){
     ...
     try{$sql = "DELETE from pagamento WHERE idPgmto =? ";
...
return TRUE;
 ...
 public function __deleteAdiantamento($id){
     ...
     try{$sql = "DELETE from adiantamento WHERE IdAdiantamento =? ";
