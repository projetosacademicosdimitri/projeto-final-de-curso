        ...
        <div class="col-md-2" style="margin-top: 10px; margin-left: 87%;">
                        ...
                        function red()
                       {
                         javascript:history.go(-1);   
							...
							if(isset($_GET['consulta'])){$pg = "onclick=\"window.location.href='../Consulta/padiantamento.php';\"";} else $pg = "onclick=\"window.location.href='../Adiantamento/ListarAdiantamento.php?pagina=$pagina';\"";   ?>
