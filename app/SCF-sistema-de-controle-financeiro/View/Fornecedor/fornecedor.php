...
<?php  include'../MasterPages/menu1.php';?>
  ...
  <table class=" table table-condensed">
    <tr>
	<td class="col-md-3"><b>Nome:</b></td><td class="col-md-3"><?php echo $vNome;?></td><td class="col-md-3"><b>Telefone:</b></td><td class="col-md-3"><?php echo $vTel ?></td>
	</tr>
	<tr>
    <td class="col-md-3"><b>Nome do Contato:</b></td><td><?php echo $vNomeContato ?></td><td class="col-md-3"><b></b></td><td></td>
       </table>                
</div>
        <div class="col-md-2" style="margin-top: 10px; margin-left: 89%; margin-bottom: 20px;">
                        ...
                        function red()
                       {
                         javascript:history.go(-1);   
						   ...
						   if(isset($_GET['consulta'])){$pg = "onclick=\"window.location.href='../Consulta/pfornecedor.php';\"";} else if(isset($_GET['inativo'])){$pg = "onclick=\"window.location.href='../Fornecedor/ListarFornInativos.php?pagina=$pagina';\"";} else $pg = "onclick=\"window.location.href='../Fornecedor/listFornecedor.php?pagina=$pagina';\"";   ?>
