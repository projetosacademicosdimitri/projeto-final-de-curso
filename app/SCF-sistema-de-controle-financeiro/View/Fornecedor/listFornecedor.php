...
<div id="wrap">    
  ...
  <div class="panel-heading"><center><h4>Lista de fornecedores</h4></center></div>
  ...
  <table class="table table-striped">
	...
	<td><b>Inativar</b></td>
       ...
       */ 
        ...
        $result = $obj->query("SELECT * FROM fornecedor WHERE Status = 'Ativo' ORDER BY Nome ASC limit $init, $por_pagina");
	$result_total = $obj->query("SELECT count(*) as total FROM fornecedor WHERE Status = 'Ativo'")->fetch(PDO::FETCH_OBJ);
        ...
        ?>
           ...
           <?php   foreach($result as $linha){  ?>
             <tr>
                ...
                <td><a href="fornecedor.php?id=<?php echo $linha['idFornecedor']; ?>&pagina=<?php echo $_GET['pagina'];?>  "><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                <td><a href="updateFornecedor.php?id=<?php echo $linha['idFornecedor'];?>&pagina=<?php echo $_GET['pagina'];?>"><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                <td><a href="../../Controller/editeFornecedor.php?inativar=<?php echo$linha['idFornecedor']; ?>&pagina=<?php echo $_GET['pagina'];?>"><span title="Inativar" style="color: #ff0000; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
	     			 </tr>
         <?php } ?> 
       </table>
</div>
       <div><a href="ListarFornInativos.php?pagina=1"><small>Fornecedores inativos</small></a></div>   
  <center>
  <ul class="pagination">
...
<?php 
  ...
  if($ctrl > 1 ){
  echo '<li><a href="listFornecedor.php?pagina=1" title="Primeira p&aacute;gina">&lt;&lt;</a></li>';
  echo '<li><a href="listFornecedor.php?pagina='.($ctrl - 1).'" title="P&aacute;gina anterior">&lt;</a></li>';
  }
  if(($ctrl - 4) < 1)
  {
      $anterior = 1;
  ...
  for($i = $anterior ; $i <=$posterior && $i<= $num_paginas ;$i++){
          ...
          echo "<li><a href=\"listFornecedor.php?pagina=$i\">$i</a></li>";
   

     }
	 if($ctrl < $num_paginas )
	 {
     echo '<li><a href="listFornecedor.php?pagina='.($ctrl + 1).'" title="Pr&oacute;xima p&aacute;gina">&gt;</a></li>';
     echo "<li><a href=\"listFornecedor.php?pagina=$num_paginas\" title=\"Ultima p&aacute;gina\">&gt;&gt;</a></li>";
	 }
     ?>
