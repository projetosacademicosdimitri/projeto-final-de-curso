...
header('Content-Type: text/html; charset=utf-8');?>
  ...
  <body>
   ...
   <?php if(isset($_GET['atv'])){ ?>
     ...
     toastr.success("Saco plástico ativado."); //parametros: 1ºmensagem,2º titulo
...
<div id="wrap">    
  ...
  <div class="panel-heading"><center><h4>Lista de sacos plásticos inativos</h4></center></div>
  ...
  <table class="table table-striped">
	...
	<td><b>Ativar</b></td>
       ...
       */ 
        ...
        $result = $obj->query("SELECT * FROM sacoplastico WHERE Status = 'Inativo' ORDER BY CorSaco,TamanhoSaco limit $init, $por_pagina");
	     $result_total = $obj->query("SELECT count(*) as total FROM sacoplastico WHERE Status = 'Inativo'")->fetch(PDO::FETCH_OBJ);
        ...
        ?>
         ...
         <?php   foreach($result as $linha){  ?>
             <tr>
                ...
                <td><a href="SacoPlastico.php?id=<?php echo $linha['IdSaco']; ?>&pagina=<?php echo $_GET['pagina'];?>&inativo  "><span  title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                <td><a href="UpdateSacoPlastico.php?id=<?php echo $linha['IdSaco']; ?>&updateinativos&pagina=<?php echo $_GET['pagina'];?>"><span  title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                <td><a href="../../Controller/editeSacoPlastico.php?ativar=<?php echo $linha['IdSaco']; ?>&pagina=<?php echo $_GET['pagina'];?>"><span  title="Ativar" style="color: #00CD00; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
	     		</tr>
         <?php } ?> 
       </table>
</div>
      <div><a href="ListarSacoPlastico.php?pagina=1"><small>Sacos ativos</small></a></div>
  <center>
  <ul class="pagination">
  ...
  if($ctrl > 1 ){
  echo '<li><a href="ListarSacoInativo.php?pagina=1" title="Primeira p&aacute;gina">&lt;&lt;</a></li>';
  echo '<li><a href="ListarSacoInativo.php?pagina='.($ctrl - 1).'" title="P&aacute;gina anterior">&lt;</a></li>';
  }
  if(($ctrl - 4) < 1)
  {
      $anterior = 1;
  ...
  for($i = $anterior ; $i <=$posterior && $i<= $num_paginas ;$i++){
          ...
          echo "<li><a href=\"ListarSacoInativo.php?pagina=$i\">$i</a></li>";
   

     }
	 if($ctrl < $num_paginas )
	 {
     echo '<li><a href="ListarSacoInativo.php?pagina='.($ctrl + 1).'" title="Pr&oacute;xima p&aacute;gina">&gt;</a></li>';
     echo "<li><a href=\"ListarSacoInativo.php?pagina=$num_paginas\" title=\"Ultima p&aacute;gina\">&gt;&gt;</a></li>";
	 }
     ?>
