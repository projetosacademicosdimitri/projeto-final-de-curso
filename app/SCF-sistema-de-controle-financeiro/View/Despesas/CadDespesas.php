...
<html>
    ...
    <title>SCA - Cadastro de Despesa</title>
  ...
  <script type="text/javascript">
    <?php if(isset($_GET['ok'])){ ?>
     ...
     toastr.success("Despesa cadastrada.","Sucesso!"); //parametros: 1ºmensagem,2º titulo
...
<div id="wrap">    
    <div class="container" style="width: 900px;">
		...
		<form role="form" class="form-horizontal" action="../../Controller/CadDespesa.php" method="post" >
                <legend>
                    Cadastro Despesa
                </legend>
                    ...
                    <div class="container" style="margin-left:30px; height:0 auto;">
						    <div class="form-group">
							    ...
							    <div class="col-md-9">
                                    ...
                                    <input type="text" class="form-control" placeholder="DescriÃ§Ã£o da Despesa"name="txtDescDesp" id="DescDesp" required/>
							    </div>
                                							
                                <div class="col-md-3">
                                    <label for="txtDataDesp">Data da Despesa</label>
                                    <input type="date" class="form-control" name="txtDatadespesa" id="DataDesp">
                                </div>
							   ...
							   <div style="margin-top: 70px;">
      							...
      							<div class="col-md-3">
				    			    ...
				    			    <input type="text" class="form-control" placeholder="Valor da Despesa" name="txtValorDespesa"     onKeyUp="moeda(this)"      id="ValorDesp">	
					    		</div> 
							   </div> 
                               							<div class="col-md-3">
                        ...
                        <button class="btn btn-primary prefix_10" type="submit">Confirmar</button> </div></div>
