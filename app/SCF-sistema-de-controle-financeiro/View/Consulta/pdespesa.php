...
if(isset($_POST['seach']))
{
  $ePesquisa = $_POST['ePesquisa'];   
    $d = $_POST['txtDescricao'];
    $t = $_POST['txtDespesaTipo'];
    $dataIni = $_POST['txtDataIni'];
    $dataFim = $_POST['txtDataFim'];
  
    
$sql="SELECT d.idDespesas, d.Descricao, d.DataDespesa, d.Valor, d.Tipo FROM despesas d WHERE 1 ";
 if($d!=""){
 $sql.=" AND d.Descricao like'%$d%' ";}
 
  if($dataIni!=""){
  $sql.=" AND d.DataDespesa >='$dataIni' ";}
  
  if($dataFim!=""){
  $sql.=" AND d.DataDespesa <='$dataFim' ";}
...
$sql.=" ORDER BY d.DataDespesa ASC";
...
<html>
    ...
    <title>SCA - Consulta de despesa</title>
...
<script src="../Front_end/Toastr/jquery-1.9.1.min.js"></script>
  ...
  <?php include '../MasterPages/menu1.php'; ?>
    ...
    <?php if(isset($_GET['ok'])){ ?>
     ...
     toastr.success("Despesa atualizada.","Sucesso!"); //parametros: 1ºmensagem,2º titulo
 
   <?php } ?>
   
   <?php if(isset($_GET['del'])){ ?>
   
     toastr.warning("Despesa deletada."); //parametros: 1ºmensagem,2º titulo
...
<form role="form" class="form-horizontal" action="pdespesa.php" method="post" >
<legend>
Pesquisa de despesa
</legend>
...
<div class="container" style="margin-left:30px; height:0 auto;">
    ...
    <div class="col-md-3">
        <label for="txtDescri">Descrição</label>
        <input type="text" class="form-control" placeholder="Descrição" name="txtDescricao" id="txtDescri" />
                                </div>
                            ...
                            <div class="col-md-3">
							    ...
							    <label >Tipo de Despesa</label>
                                    ...
                                    <select name="txtDespesaTipo" class="form-control">
...
<div class=" panel panel-primary" style="margin-top:10px; width: 870px; margin: 0 auto;">
    ...
    <table class="table table-striped">
        ...
        <td><?php echo $linha->Descricao; ?></td>
            <td><?php echo implode("/",array_reverse(explode("-",$linha->DataDespesa) ) ); ?></td>
            <td><?php echo $linha->Tipo; ?></td>
            <td><a href="../Despesas/Despesa.php?id=<?php echo $linha->idDespesas; ?>&consulta&pagina=1"><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                <td><a href="../Despesas/UpdateDespesa.php?id=<?php echo $linha->idDespesas; ?>&consulta&pagina=1"><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                <td><a onclick="return confirm('Deseja realmente excluir este registro?');" href="../../Controller/editeDespesa.php?C_delete=<?php echo $linha->idDespesas; ?>&pagina=1"><span title="Excluir" style="color: #ff0000; margin-left: 23%;" class="glyphicon glyphicon-remove"></span></a></td> 	
