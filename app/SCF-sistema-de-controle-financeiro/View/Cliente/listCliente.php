        ...
        <div id="wrap">    
            <div class="container" style="width: 900px;">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading"><center><h4>Lista de Clientes</h4></center></div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td><a href="cliente.php?id=<?php echo $linha['idCliente']; ?>&pagina=<?php echo $_GET['pagina']; ?>  "><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                                <td><a href="updateCliente.php?id=<?php echo $linha['idCliente']; ?>&pagina=<?php echo $_GET['pagina']; ?>"><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                                <td><a href="../../Submit/cliente.php?inativar=<?php echo $linha['idCliente']; ?>&pagina=<?php echo $_GET['pagina']; ?>"><span title="Inativar" style="color: #ff0000; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
                            </tr>
                        <?php } ?> 
                    </table>
                </div>
                <div><a href="listClientesInativos.php?pagina=1"><small>Clientes inativos</small></a></div>
                <center>
                    <ul class="pagination">
