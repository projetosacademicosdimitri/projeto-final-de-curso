...
<script type="text/javascript">
    <?php if(isset($_GET['ok'])){ ?>
     ...
     toastr.success("Venda cadastrada.","Sucesso!"); //parametros: 1ºmensagem,2º titulo
		...
		<form role="form" class="form-horizontal" action="../../Controller/CadVenda.php" method="post" >
			...
			<div class="form-group">
				...
				<div class="col-md-3">
				    ...
				    <input type="text" class="form-control"    required  onblur="mult();" placeholder="Valor unitÃ¡rio" name="txtValorUnitario" id="txtValorUni" onKeyUp="moeda(this)" /> 
				</div> 
			</div> 
