...
<html>
    <head>
        ...
        <title>SCA - Lista de Funcionários Inativos</title>
        ...
        <div id="wrap">    
            <div class="container" style="width: 900px;">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading"><center><h4>Lista de funcionários inativos</h4></center></div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            $result = $funcionarioController->execulteAcao('paginacao.inativos.funcionario', $funcionario = null, $idfuncionario = null, $paginacao);
                            $result_total = $funcionarioController->execulteAcao('conte.total.inativos.funcionario');
                            ...
                            <tr>
                                ...
                                <td><a href="funcionario.php?id=<?php echo $linha['idFunc']; ?>&pagina=<?php echo $_GET['pagina']; ?>&inativo  "><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                                <td><a href="updateFunc.php?id=<?php echo $linha['idFunc']; ?>&updateinativos&pagina=<?php echo $_GET['pagina']; ?>  "><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></a></td>
                                <td><a href="../../Controller/editeFunc.php?ativar=<?php echo $linha['idFunc']; ?>&pagina=<?php echo$_GET['pagina']; ?>"><span title="Ativar" style="color: #00CD00; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
                            </tr>
                        <?php } ?> 
                    </table>
                </div>

                <div><a href="listarFunc.php?pagina=1"><small>Funcionários ativos</small></a></div>
                ...
                <center>
                    <ul class="pagination">
                        ...
                        if ($paginacao->inicio > 1) {
                            echo '<li><a href="ListarFuncInativos.php?pagina=1" title="Primeira p&aacute;gina">&lt;&lt;</a></li>';
                            echo '<li><a href="ListarFuncInativos.php?pagina=' . ($ctrl - 1) . '" title="P&aacute;gina anterior">&lt;</a></li>';
                        }
                        ...
                        for ($i = $anterior; $i <= $posterior && $i <= $num_paginas; $i++) {
                            ...
                            echo "<li><a href=\"ListarFuncInativos.php?pagina=$i\">$i</a></li>";
                        }
                        if ($paginacao->inicio < $num_paginas) {
                            echo '<li><a href="ListarFuncInativos.php?pagina=' . ( $paginacao->inicio + 1) . '" title="Pr&oacute;xima p&aacute;gina">&gt;</a></li>';
                            echo "<li><a href=\"ListarFuncInativos.php?pagina=$num_paginas\" title=\"Ultima p&aacute;gina\">&gt;&gt;</a></li>";
                        }
                        ?>
