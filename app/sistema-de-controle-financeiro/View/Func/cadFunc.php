...
<script type="text/javascript">  
	...
	jQuery(function($){
      ...
      <form role="form" class="form-horizontal" action="../../Controller/CadastroFunc.php" method="post" >
                <legend>
					...
					<div class="container" style="margin-left:30px; height:0 auto;">
                        ...
                        <div class="col-md-2" style="margin-top: 10px; margin-left: 85%; margin-bottom: 20px;">
                            <button class="btn btn-primary prefix_10" type="submit" name="Cadastrar" value="" >Cadastrar</button> </div></div>
