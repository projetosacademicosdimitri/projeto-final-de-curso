                ...
                <form role="form" class="form-horizontal" action="../../Submit/funcionario.php" method="POST" >
                    ...
                    <div class="container" style="margin-left:30px; height:0 auto;">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control"  value="<?php echo $nome; ?>"placeholder="Nome Completo" name="txtNomFunc" id="txtNomF" required/>
                            </div>

                            <div class="col-md-3">
                                <label for="txtCpfF">CPF</label>
                                <input type="text" class="form-control"  placeholder="CPF"  value="<?php echo $cpfFunc; ?>" name="txtCpfFunc" id="txtCpfF" required/>
                            </div> 

                            <div class="col-md-3">
                                <label for="txtRgF">RG</label>
                                <input type="text" class="form-control" placeholder="RG"    value="<?php echo$rgFunc; ?>"  name="txtRgFunc"  id="txtRgF" />
                            </div> 
                            ...
                            <div style="margin-top: 70px;">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Telefone" value='<?php echo $telFunc; ?>' name="txtTelFunc" id="txtTelF">	
                                </div> 

                                <div class="col-md-3">
                                    <label for="txtCelF">Celular</label>
                                    <input type="text" class="form-control" placeholder="Celular" name="txtCelFunc"  value="<?php echo $celFunc; ?>" id="txtCelF">
                                </div>

                                <div class="col-md-3">
                                    <label for="txtCargoF">Cargo</label>
                                    <input type="text" class="form-control" placeholder="Cargo" name="txtCargoFunc" id="txtCargoF"   value="<?php echo$cargo ?>">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container" style="margin-left:30px; height:0 auto;">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text"   value="<?php echo$endFunc ?> "class="form-control" placeholder="Endereço" name="txtEndFunc" id="txtEndF">
                            </div>

                            <div class="col-md-3">
                                <label for="txtNumF">N&uacute;mero</label>
                                <input type="text" value="<?php echo $numeroFunc; ?>" class="form-control" placeholder="000" name="txtNumFunc" id="txtNumF">
                            </div> 
                            ...
                            <div style="margin-top: 70px;">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" value="<?php echo$bairroFunc; ?>" class="form-control" placeholder="Bairro" name="txtBaiFunc" id="txtBaiF">
                                </div> 

                                <div class="col-md-3">
                                    <label for="txtCidF">Cidade</label>
                                    <input type="text"  value="<?php echo$cidadeFunc ?>" class="form-control" placeholder="Cidade" name="txtCidFunc" id="tstCidF">
                                </div> 
                            </div> 

                            <div class="col-md-3">
                                <label for="txtCep">CEP</label>
                                <input type="text"  value="<?php echo$cepFunc ?> "  class="form-control" placeholder="xxxxxx-xxx" name="txtCepFunc" id="txtCepF">
                            </div>
                            <div class="col-md-3">
                                <label>UF</label>
                                <select name="txtUfFunc" class="form-control">
                                    <option  selected="<?php echo$estadoFunc ?> "value="<?php echo$estadoFunc ?>"><?php echo$estadoFunc ?></option>
                    ...
                    <div class="container" style="margin-left:30px; height:0 auto;">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo$ctpsFunc ?>" placeholder="Numero" name="txtNCT" id="txtNCTF" >
                            </div>

                            <div class="col-md-3">
                                <label for="txtNSCF">N&uacute;mero S&eacute;rie</label>
                                <input type="text" class="form-control" placeholder="N° Serie" name="txtNSC" value="<?php echo$serie; ?>" id="txtNSCF" >
                            </div> 
                            ...
                            <div style="margin-top: 70px;" >
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="PIS"  value="<?php echo$pisFunc ?>" name="txtPIS" id="txtPISF" >
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control"  value="<?php echo$salario; ?>"    onKeyUp="moeda(this)"   placeholder="Salario" name="txtSal" id="txtSalF">	
                                </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-2" style="margin-top: 10px; margin-left: 85.5%; margin-bottom: 20px;">
                            <button class="btn btn-primary prefix_10" type="submit" name="edite_funcionario" value="" >GRAVAR</button> </div></div>
