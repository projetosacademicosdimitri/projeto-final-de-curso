...
$sql="SELECT a.IdAdiantamento, f.Nome, a.DataAdiantamento, a.ValorAdiantamento FROM adiantamento a INNER JOIN funcionario f ON a.IdFunc = f.idFunc ";
 if($n!=""){
 $sql.=" AND f.Nome like'%$n%' ";}
  if($dataIni!=""){
  $sql.=" AND a.DataAdiantamento >='$dataIni' ";}
  if($dataFim!=""){
  $sql.=" AND a.DataAdiantamento <='$dataFim' ";}
  
$sql.=" ORDER BY a.DataAdiantamento ASC";
...
<html>
    ...
    <title>SCA - Consulta adiantamento</title>
...
<form role="form" class="form-horizontal" action="padiantamento.php" method="post" >
<legend>
Pesquisa de adiantamento
</legend>
...
<div class=" panel panel-primary" style="margin-top:10px; width: 870px; margin: 0 auto;">
    ...
    <table class="table table-striped">
        ...
        <td><?php echo $linha->Nome; ?></td>
            <td><?php echo implode("/",array_reverse(explode("-",$linha->DataAdiantamento) ) ); ?></td>
            <td><?php echo number_format($linha->ValorAdiantamento, 2, ',', '.'); ?></td>
            <td><a href="../Adiantamento/Adiantamento.php?id=<?php echo $linha->IdAdiantamento; ?>&consulta&pagina=1"><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                <td><a href="../Adiantamento/UpdateAdiantamento.php?id=<?php echo $linha->IdAdiantamento; ?>&consulta&pagina=1"><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                <td><a onclick="return confirm('Deseja realmente excluir este registro?');" href="../../Controller/editeAdiantamento.php?C_delete=<?php echo $linha->IdAdiantamento; ?>&pagina=1"><span title="Excluir" style="color: #ff0000; margin-left: 23%;" class="glyphicon glyphicon-remove"></span></a></td> 	
