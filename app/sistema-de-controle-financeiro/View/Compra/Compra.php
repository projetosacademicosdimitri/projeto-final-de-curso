...
<html lang="en" class="translated-ltr"><head>
    ...
    <title>SCA - Dados da compra</title>
...
$vDataCompra = implode("/",array_reverse(explode("-",$linhas['DataCompra']) ) );
...
<div id="wrap">    
  ...
  <div class="panel-heading"><center><h4>Dados da Compra</h4></center></div>

  <!-- Table -->
  
  <table class=" table table-condensed">
    <tr>
	<td class="col-md-3"><b>Material:</b></td><td class="col-md-3"><?php echo $vMaterial;?></td><td class="col-md-3"><b>Data da compra:</b></td><td class="col-md-3"><?php echo $vDataCompra ?></td>
	</tr>
	
      <tr>
    <td class="col-md-3"><b>Fornecedor:</b></td><td><?php echo $vFornecedor; ?></td>
    ...
    <td class="col-md-3"><b>Quantidade:</b></td><td><?php echo $vQuantidade; ?></td>
        ...
        <tr>
   <td class="col-md-3"><b>Valor unitário:</b></td><td>R$ <?php echo $vValorUnitario ?></td>
	
    <td class="col-md-3"><b>Valor Total:</b></td><td>R$ <?php echo $vValorTotal; ?></td><td class="col-md-3"><b></b></td><td></td>
	</tr>
        ...
        <div class="col-md-2" style="margin-top: 10px; margin-left: 89%; margin-bottom: 20px;">
							...
							if(isset($_GET['consulta'])){$pg = "onclick=\"window.location.href='../Consulta/pcompra.php';\"";} else $pg = "onclick=\"window.location.href='../Compra/listarCompra.php?pagina=$pagina';\"";   ?>
