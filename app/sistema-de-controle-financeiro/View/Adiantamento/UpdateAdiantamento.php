...
<html lang="en" class="translated-ltr"><head>
    ...
    <title>SCA - Atualizar dados do adiantamento</title>
...
$vNome = $linhas['Nome'];
$vDataAdiantamento = $linhas['DataAdiantamento'];
...
<div id="wrap">    
    <div class="container" style="width: 900px;">
		...
		<form role="form" class="form-horizontal" action="../../Controller/editeAdiantamento.php" method="post" >
                <legend>
                    Atualizar dados do adiantamento
                </legend>
			...
			<div class="form-group">
                           ...
                           <div class="col-md-6">
                                    ...
                                    <select name="IdFunc" class="form-control" id="IdFuncionario">
                                        <option value="<?php  echo $vIdFunc; ?>"><?php echo $vNome; ?></option>
                                  <?php  $oPessit = new CmdSql();
                               
                               foreach($oPessit-> __listAllFuncionario() as $linha ){?> 
				...
				<div class="col-md-3">
                                    ...
                                    <input type="date" value="<?php echo $vDataAdiantamento; ?>" class="form-control" name="txtDataAdiantamento" id="DateAdiantamento">
				</div> 
				    ...
				    <input type="text" value="<?php echo $vValorAdiantamento;?>" class="form-control"  required   placeholder="Valor do adiantamento" name="txtValorAdiantamento" id="txtValorAdiantamento" onKeyUp="moeda(this);" /> 
				</div>
