                ...
                <div class="panel panel-primary">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            $result = $fornecedorController->executeAcao('paginacao.inativos.fornecedor', $cliente = null, $idCliente = null, $paginacao);
                            $result_total = $fornecedorController->executeAcao('conte.total.inativos.fornecedor');
                            ...
                            <tr>
                                ...
                                <td><a href="../../Submit/fornecedor.php?ativar=<?php echo$linha['idFornecedor']; ?>&pagina=<?php echo $_GET['pagina']; ?>"><span title="Ativar" style="color: #00CD00; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
                            </tr>
                        <?php } ?> 
                    </table>
                </div>
                ...
                <center>
                    <ul class="pagination">
                        ...
                        if ($paginacao->inicio < $num_paginas) {
                            echo '<li><a href="ListarFornInativos.php?pagina=' . ($paginacao->inicio + 1) . '" title="Pr&oacute;xima p&aacute;gina">&gt;</a></li>';
