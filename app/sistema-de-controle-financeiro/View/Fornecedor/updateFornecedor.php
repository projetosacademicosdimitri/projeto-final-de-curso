...
<body>
    ...
    <div id="wrap">    
        <div class="container" style="width: 900px;">
            ...
            <form role="form" class="form-horizontal" action="../../Submit/fornecedor.php" method="POST" >
                <legend>
                ...
                <div class="container" style="margin-left:30px; height:0 auto;">
                    <div class="form-group">
                        <div class="col-md-9">
                            ...
                            <input type="text" class="form-control" placeholder="Nome Completo"  value ="<?php echo $nome ?>"name="txtNomFornecedor" id="txtNomFor" required/>
                        </div>
                        <div class="col-md-3">
                            <label for="txtTelFor">Telefone</label>
                            <input type="text" class="form-control"  placeholder="Telefone"  value="<?php echo $tel; ?>" name="txtTelFornecedor" id="txtTelFor">	
                        </div> 
                        <div style="margin-top: 70px;">
                            <div class="col-md-9">
                                <label for="txtContatoFor">Nome do contato</label>
                                <input type="text" class="form-control"  placeholder="Nome do contato" value="<?php echo$nomeContato; ?>" name="txtNomeContatoFor" id="txtContatoFor">
                            </div>
                        </div> 
                    </div>
                </div><!--/container dados do funcionário-->
                <input type="hidden" name="id"  value="<?php echo $idFornecedor; ?>" />
                <input type="hidden" name="pagina"  value="<?php echo $_GET['pagina']; ?>" />
                <div class="form-group">
                    <div class="col-md-2" style="margin-top: 10px; margin-left: 87%; margin-bottom: 20px;">
                    <button class="btn btn-primary prefix_10" name="edite_fornecedor" type="submit">Gravar</button> </div></div>
            </form>	 
        </div> <!-- /container -->
    </div>
