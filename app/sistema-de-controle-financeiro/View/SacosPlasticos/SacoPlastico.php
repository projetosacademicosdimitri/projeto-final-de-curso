...
<html lang="en" class="translated-ltr"><head>
    ...
    <title>SCA - Dados do saco plástico</title>
...
<div id="wrap">    
  ...
  <div class="panel-heading"><center><h4>Dados do saco plástico</h4></center></div>

  <!-- Table -->
  
  <table class=" table table-condensed">
    <tr>
	<td class="col-md-3"><b>Material:</b></td><td class="col-md-3">Saco</td>
        <td class="col-md-3"><b>Cor:</b></td><td class="col-md-3"><?php echo $vCorSaco; ?></td>
	</tr>
	
       
        
     <tr>
    <td class="col-md-3"><b>Litro:</b>
    <td><?php echo $vTamanhoSaco;?></td>   
        ...
        <div class="col-md-2" style="margin-top: 10px; margin-left: 85%; margin-bottom: 20px;">
                        ...
                        function red()
                       {
					    ...
					    <?php $pagina = $_GET['pagina'];
						 if(isset($_GET['inativo'])){$pg = "onclick=\"window.location.href='../SacosPlasticos/ListarSacoInativo.php?pagina=$pagina';\"";} else $pg = "onclick=\"window.location.href='../SacosPlasticos/ListarSacoPlastico.php?pagina=$pagina';\"";   ?>
                            <button class="btn btn-primary prefix_10" type="button" name="gravar" <?php echo $pg;?> value="" ><span class="glyphicon glyphicon-arrow-left" style="margin-right: 5px;"></span>Voltar</button> </div></div>
    </div> <!-- /container -->
</div>
