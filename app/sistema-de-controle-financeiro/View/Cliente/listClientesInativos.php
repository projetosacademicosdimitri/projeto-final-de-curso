        ...
        <div id="wrap">    
            <div class="container" style="width: 900px;">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading"><center><h4>Lista de Clientes inativos</h4></center></div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            $paginacao->inicio =  $_GET['pagina'] - 1; // ( $_GET['pagina'] < 1 ) ? 1 : $_GET['pagina'];
                            
                            $paginacao->qtdPorPagina = 10;
                            $result = $clienteController->execulteAcao('paginacao.inativos.cliente', $cliente = null, $idCliente = null, $paginacao);
                            $result_total = $clienteController->execulteAcao('conte.total.inativos.cliente');
                            ...
                            <tr>
                                ...
                                <td><a href="cliente.php?id=<?php echo $linha['idCliente']; ?>&pagina=<?php echo $_GET['pagina']; ?>&inativo  "><span title="Visualizar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-search"></span></a></td>
                                <td><a href="updateCliente.php?id=<?php echo $linha['idCliente']; ?>&updateinativos&pagina=<?php echo $_GET['pagina']; ?>"><span title="Editar" style="color: #000000; margin-left: 23%;" class="glyphicon glyphicon-edit"></span></a></td>
                                <td><a href="../../Submit/cliente.php?ativar=<?php echo $linha['idCliente']; ?>&pagina=<?php echo $_GET['pagina']; ?>"><span title="Ativar" style="color: #00CD00; margin-left: 23%;" class="glyphicon glyphicon-off"></span></a></td> 	
                            </tr>
                        <?php } ?> 
                    </table>
                </div>

                <div><a href="listCliente.php?pagina=1"><small>Clientes ativos</small></a></div>
                <center>
                    <ul class="pagination">

                        <?php
                        if ($paginacao->inicio > 1) {
                            echo '<li><a href="listClientesInativos.php?pagina=1" title="Primeira p&aacute;gina">&lt;&lt;</a></li>';
                            echo '<li><a href="listClientesInativos.php?pagina=' . ($ctrl - 1) . '" title="P&aacute;gina anterior">&lt;</a></li>';
                        }
                        ...
                        for ($i = $anterior; $i <= $posterior && $i <= $num_paginas; $i++) {
                            ...
                            echo "<li><a href=\"listClientesInativos.php?pagina=$i\">$i</a></li>";
                        }
                        if ($paginacao->inicio < $num_paginas) {
                            echo '<li><a href="listClientesInativos.php?pagina=' . ($paginacao->inicio + 1) . '" title="Pr&oacute;xima p&aacute;gina">&gt;</a></li>';
                            echo "<li><a href=\"listClientesInativos.php?pagina=$num_paginas\" title=\"Ultima p&aacute;gina\">&gt;&gt;</a></li>";
                        }
                        ?>
